...
This data could possibly use a linear classifier to define a decision boundary because it does look like the two sets of data are separate from each other in their accuracy results.
