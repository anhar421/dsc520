...
```
Using Gender as the control variable, it actually increases the strong negative relationship between TimeReading and TimeTv. This provides more evidence that the relationship between the two actually exists apart from the other variables. This would suggest that more time spent watching TV would decrease the time spent reading, and vice versa.