...
## R interpreted names as factors, which is not the behavior we want (this isn't true anymore)
...
voter_turnout_df1 <- read_excel("data/G04ResultsDetail2004-11-02.xls", sheet = 2,
                                 skip = 1)
...
voter_turnout_df2 <- read_excel("data/G04ResultsDetail2004-11-02.xls", sheet = 2,
                                col_names = c("ward_precinct", "ballots_cast", 
...
tables <- lapply(table_names, dbReadTable, con = db)
tables
