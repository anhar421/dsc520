...
# sum(week1_sleep > 8) This worked to complete the task but after looking at the
# expected output, I realized you wanted something different.
week1_sleep > 8
...
grades <- cbind(grades, c(assignment03))
...
colSums(grades, na.rm = TRUE)

## Total points for each student using `rowSums()`
rowSums(grades, na.rm = TRUE)
